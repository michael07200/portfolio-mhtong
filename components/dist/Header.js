...
function Header(_a) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-black/70" : "" },
            React.createElement("div", { className: nav
                ...
                React.createElement("div", null,
                    React.createElement("div", { className: "flex w-full items-center justify-between" },
                        ...
                        React.createElement("div", { onClick: handleNav, className: "rounded-full shadow-lg shadow-gray-400 p-2 cursor-pointer" },
                            React.createElement(ai_1.AiOutlineClose, null))),
                    React.createElement("div", { className: "border-b border-gray-300 my-6" },
