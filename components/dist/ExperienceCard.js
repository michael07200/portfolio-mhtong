...
function ExperienceCard(props) {
    return (react_1["default"].createElement("article", { className: "flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#62973D] p-10 hover:opacity-100 opacity-50 cursor-pointer transition-opacity duration-200 overflow-hidden" },
        ...
        react_1["default"].createElement("div", { className: "text-white" },
            react_1["default"].createElement("h4", { className: "text-4xl font-light" }, props.exp.position),
            react_1["default"].createElement("p", { className: "font-bold text-2xl mt-1" }, "Popma ter Steege"),
            ...
            react_1["default"].createElement("ul", { className: "list-disc space-y-4 ml-5 text-lg" }, props.exp.summaryPoints.content.map(function (content) {
                return react_1["default"].createElement("li", null, "content");
            })))));
}
